    ...
    return (
      <div>
        ...
        <ToggleDisplay show={this.state.show}>
          <p>
            This job sounds better than it actually was. I was a salesman and my product was debt. The bank made a ton of money from credit cards and home equity loans, therefore, everyone who walked through the door should leave with a shiny new credit card in their wallet and/or a new line of credit. To use the old cliché, I felt like a slimy used car salesman. For what it's worth, I was the top banker in my branch.
          </p>
          <p><strong>What I Learned</strong></p>
          <ul>
            <li>When it comes to money, people are <em>very</em> serious.</li>
            ...
            <li>Sales should not have to be high pressure if your product solves a real problem.</li>
          </ul>
        </ToggleDisplay>
      </div>
    )
